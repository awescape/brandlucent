...
<form action="https://komahony.us8.list-manage.com/subscribe/post?u=0d3dbdd5d7e7017a3a191fe58&amp;id=ab34df1263" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate project-inquiry" target="_blank" novalidate>
	...
	<div id="form-page-1" class="form-page form-page-1">
		...
		<div class="form-input-wrapper">
			...
			<input type="text" value="" name="COMPANY" class="" id="mce-COMPANY" placeholder="Company name here">
		</div>
	...
	<div id="form-page-2" class="form-page form-page-2">
		...
		<div class="form-input-wrapper">
				...
				<div class="checkbox-wrapper">
					<div class="checkbox">
						<label>
							<input type="checkbox" value="1" name="group[20301][1]" id="mce-group[20301]-20301-0">
					...
					<div class="checkbox">
						<label>
							<input type="checkbox" value="2" name="group[20301][2]" id="mce-group[20301]-20301-1">
							<i class="fa fa-check" aria-hidden="true"></i>
						</label>
					...
					<div class="checkbox">
						<label>
							<input type="checkbox" value="4" name="group[20301][4]" id="mce-group[20301]-20301-2">
							<i class="fa fa-check" aria-hidden="true"></i>
						</label>

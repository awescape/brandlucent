    ...
    <?php while( have_rows('portfolio_items') ): the_row(); ?>
		...
		<div class="panel panel-<?php echo $f; ?>" data-color="<?php echo get_sub_field('project_color') ;?>">
			...
			<div class="work-blurb">
			  	...
			  	<div class="banner-line <?php if ($f > 1)echo "hideme";?>"></div>
			  	...
			  	<p class="work-blurb-content <?php if ($f > 1)echo "hideme";?>">
			  		...
			  		<?php while( have_rows('project_tags') ): the_row(); ?>
					  	<div class="project-tags <?php if ($f > 1)echo "hideme";?>"><a  href="<?php echo get_sub_field('project_tag_link') ;?>">
					  			<p><?php echo get_sub_field('project_tag') ;?></p>
					  	</a></div>
			  		<?php endwhile; ?>

			<br><a class="learn-more-text <?php if ($f > 1)echo "hideme";?>" href="<?php echo get_sub_field('project_page_link') ;?>">
			  		<div>
		  ...
		  <div class="work-images">
		  	...
		  	<img id="prlx_lyr_mobile<?php echo $f; ?>" class="project-image-mobile project-image-mobile-<?php echo $f; ?>" src="<?php echo get_sub_field('project_image_mobile') ;?>">
		  </div> 
